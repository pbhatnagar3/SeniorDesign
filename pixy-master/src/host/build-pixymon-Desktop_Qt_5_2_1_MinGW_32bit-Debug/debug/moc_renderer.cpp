...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Renderer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 16, 11)
    ...
    "Renderer\0image\0\0renderFlags\0"
};
...
static const uint qt_meta_data_Renderer[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QImage, QMetaType::UChar,    1,    3,
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Renderer::*_t)(QImage , uchar );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Renderer::image)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Renderer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Renderer.data,
      qt_meta_data_Renderer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Renderer.stringdata))
